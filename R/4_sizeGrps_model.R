...
mdat <- usedat %>% 
  ...
  filter_out(sizeGrp == "OTHER" | is.na(temp_C)) %>% 
...
library(emmeans) # Estimated marginal means
  # use this because glmmTMB is supported and it's tidier to estimate Q10

# Extract slopes and calculate Q10 for each sizeGrp
