# Calculating allZoop ingestion rate Q10s
# Josh Hill
# 10/02/2026
...
usedat <- dat %>% 
  ...
  usedat %>%
    ...
    theme_bw() +
    labs(
      x = "Ingestion rate (Cspecific_rate, log scale)",
      y = "Count",
...
# Save it
# saveRDS(Q10dat, "Data/allZoop_analysis/allZoop_ingestion_Q10_data.rds")
...
# saveRDS(arrhenius_obj, "Data/allZoop_analysis/allZoop_ingestion_arrhenius_data.rds")
